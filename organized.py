...
def authenticate_drive_api(credentials_file):
...
def main():
    ...
    credentials_file = st.file_uploader("Upload your Google Drive credentials.json", type="json")
    if credentials_file:
        with open("credentials.json", "wb") as f:
            f.write(credentials_file.read())
        drive_service = authenticate_drive_api("credentials.json")
        ...
        st.warning("Please upload your credentials.json file.")
